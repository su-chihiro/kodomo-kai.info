...
<head>
  ...
  <title>404 Error：ページが見つかりませんでした</title>
    ...
    <main role="main" class="container pt-4" style="">
      <div class="row">
        <div class="col-md-12 order-md-1">
          <div class="needs-validation rounded p-3 mb-3">
            <div class="row">
              <div class="col-md-12">
                <img src="/error/img/404/404-jp.png" class="img-fluid mx-auto d-block" alt="404 Error">
              </div>
            </div>
          </div>
        </div>
