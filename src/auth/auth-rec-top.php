...
<head>
  ...
  <title>管理者用 レクリエーション - 子ども会を変えたい</title>
        ...
        <div class="col-md-12 order-md-1">
          ...
          <div class="row">
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=0">
                <div class="">
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=1">
                <div class="">
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=2">
                <div class="">
                  <!-- <img src="/img/404/error.png" width="100" height="100"> -->
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=3">
                <div class="">
                  <!-- <img src="/img/404/error.png" width="100" height="100"> -->
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=4">
                <div class="">
                  <!-- <img src="/img/404/error.png" width="100" height="100"> -->
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=5">
                <div class="">
            ...
            <div class="col-md-4 text-center">
              <a class="h3" href="./auth-soleRecList.php?p=6">
                <div class="">
                  <img src="/img/404/error.png" width="100" height="100">
            ...
            <div class="col-md-4 text-center mb-3">
              <a class="h3" href="./auth-soleRecList.php?p=7">
                <div class="">
                  <img src="/img/404/error.png" width="100" height="100">
                </div>
